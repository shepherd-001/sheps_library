...
public final class ErrorMessage {
    ...
    public static final String VERIFY_EMAIL_ADDRESS = "Please verify your email address before your proceed";
    public static final String INVALID_CURRENT_PASSWORD =  "Invalid current password";
    public static final String SAME_OLD_AND_NEW_PASSWORD =  "New password cannot be the same as the current password";
