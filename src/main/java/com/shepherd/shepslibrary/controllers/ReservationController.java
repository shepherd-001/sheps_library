...
public class ReservationController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> reserveBook(@RequestParam
    ...
    @PreAuthorize("hasRole('MEMBER')")
    @GetMapping("/get")
    public ResponseEntity<Object> getReservationById(@RequestParam
                                                         @NotNull(message = ValidationMessage.NULL_RESERVATION_ID)
                                                         UUID reservationId){
        return ResponseEntity.ok(BaseResponse
    ...
    public ResponseEntity<Object> getAllReservationsByUserId(@RequestParam
    ...
    @PreAuthorize("hasRole('MEMBER')")
    public ResponseEntity<Object> deleteReservation(@PathVariable
                                                        @NotNull(message = ValidationMessage.NULL_RESERVATION_ID)
                                                        UUID reservationId,
                                                    @PathVariable
                                                        @NotNull(message = ValidationMessage.NULL_USER_ID)
    ...
    @PreAuthorize("hasRole('MEMBER')")
    public ResponseEntity<Object> deleteAllReservations(@PathVariable
                                                            @NotNull(message = ValidationMessage.NULL_USER_ID)
                                                            UUID userId){
