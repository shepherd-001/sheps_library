...
public class ReservationController {
    ...
    public ResponseEntity<Object> getAllReservationsByUserId(@RequestParam UUID userId, @RequestParam int pageNumber){
        return ResponseEntity.ok(BaseResponse
    ...
    @GetMapping("/get-all")
    public ResponseEntity<Object> getAllReservations(@RequestParam int pageNumber){
        return ResponseEntity.ok(BaseResponse
